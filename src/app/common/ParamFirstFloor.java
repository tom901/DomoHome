...
//    public static final int SIXTH_LITTLE_LIGHT_Y = (FIFTH_LITTLE_ROOM_HEIGHT / 2) + FIFTH_LITTLE_ROOM_Y;
    ...
    public static final int THIRD_ROOM_DOOR_X = GARDEN_ROOM_WIDTH + 3;
    ...
    public static final int FIRST_LITTLE_ROOM_DOOR_X = (FIRST_LITTLE_ROOM_WIDTH / 2) + ParamDisplay.X_MINI_MAP;
    public static final int FIRST_LITTLE_ROOM_DOOR_Y = ParamDisplay.Y_FIRST_LITTLE_MAP + FIRST_LITTLE_ROOM_HEIGHT - 5;

    public static final int SECOND_LITTLE_ROOM_DOOR_X = SECOND_LITTLE_ROOM_X - 3;
    public static final int SECOND_LITTLE_ROOM_DOOR_Y = (SECOND_LITTLE_ROOM_HEIGHT / 2) + ParamDisplay.Y_FIRST_LITTLE_MAP;

    public static final int THIRD_LITTLE_ROOM_DOOR_X = THIRD_LITTLE_ROOM_X + GARDEN_LITTLE_ROOM_WIDTH;
    public static final int THIRD_LITTLE_ROOM_DOOR_Y =GARDEN_LITTLE_HEIGHT + ParamDisplay.Y_FIRST_LITTLE_MAP+ 5;

    public static final int FOURTH_LITTLE_ROOM_DOOR_X = THIRD_LITTLE_ROOM_WIDTH/2 + THIRD_LITTLE_ROOM_X - 2;
    public static final int FOURTH_LITTLE_ROOM_DOOR_Y = (GARDEN_LITTLE_HEIGHT+FIRST_LITTLE_ROOM_HEIGHT + ParamDisplay.Y_FIRST_LITTLE_MAP) - 5;

    public static final int FIFTH_LITTLE_ROOM_DOOR_X = FIFTH_LITTLE_ROOM_X + 2;
    public static final int FIFTH_LITTLE_ROOM_DOOR_Y =(GARDEN_LITTLE_HEIGHT+FIRST_LITTLE_ROOM_HEIGHT + ParamDisplay.Y_FIRST_LITTLE_MAP) - 5;
