...
//    public static final int SIXTH_LITTLE_LIGHT_Y = (FIFTH_LITTLE_ROOM_HEIGHT / 2) + FIFTH_LITTLE_ROOM_Y;
    ...
    public static final int FIRST_LITTLE_ROOM_DOOR_Y = ParamDisplay.Y_FIRST_LITTLE_MAP+ FIRST_LITTLE_ROOM_HEIGHT   ;

    public static final int SECOND_LITTLE_ROOM_DOOR_X = (SECOND_LITTLE_ROOM_WIDTH );
    public static final int SECOND_LITTLE_ROOM_DOOR_Y = (SECOND_LITTLE_ROOM_HEIGHT / 2);

    public static final int THIRD_LITTLE_ROOM_DOOR_X = GARDEN_LITTLE_ROOM_WIDTH ;
    public static final int THIRD_LITTLE_ROOM_DOOR_Y = (FIRST_LITTLE_ROOM_HEIGHT + (FIRST_LITTLE_ROOM_HEIGHT / 2));

    public static final int FOURTH_LITTLE_ROOM_DOOR_X = THIRD_LITTLE_ROOM_HEIGHT ;
    public static final int FOURTH_LITTLE_ROOM_DOOR_Y = (FIFTH_LITTLE_ROOM_HEIGHT + FIRST_LITTLE_ROOM_HEIGHT);

    public static final int FIFTH_LITTLE_ROOM_DOOR_X = FOURTH_LITTLE_ROOM_WIDTH + (FIRST_LITTLE_ROOM_WIDTH / 8);
    public static final int FIFTH_LITTLE_ROOM_DOOR_Y = (FIFTH_LITTLE_ROOM_HEIGHT + FIRST_LITTLE_ROOM_HEIGHT);
