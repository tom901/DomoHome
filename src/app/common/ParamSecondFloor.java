...
public class ParamSecondFloor {
    ...
    public static final int SECOND_LITTLE_HEIGHT =(ParamDisplay.MAIN_FLOOR_DISPLAYED_HEIGHT/2)/4;
    ...
    public static final int THIRD_LITTLE_ROOM_Y = SECOND_LITTLE_HEIGHT+SECOND_LITTLE_ROOM_Y;
